...
const Fuel2 = () => {
    ...
    const handleContinue = () => {
        if (!coalAmount || isNaN(parseFloat(coalAmount)) || parseFloat(coalAmount) <= 0) {
            alert('Please enter a valid coal consumption in kg.');
            return;
        }
        updateCarbonData('coal', parseFloat(coalAmount));
        navigate('/CCF-Calculator/fuel3');
    };
        ...
        <div className="ccf-individual-screen-container">
            ...
            <div className="ccf-individual-screen-content">
                <h2 className="ccf-individual-question-text" data-aos="fade-up" data-aos-duration="800">
                    What's the total coal consumption per year?
                </h2>
                <input
                    type="text"
